...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUpWithEmailAndPassword"])(email, password, name);
    ...
    const handleGoogleSignIn = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithGoogle"])(router);
        } catch (error) {
...
//# sourceMappingURL=src_be34d2cd._.js.map