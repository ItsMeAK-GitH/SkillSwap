...
function LoginPage() {
    ...
    const handleEmailSignIn = async (e)=>{
        e.preventDefault();
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(email, password);
            router.push('/');
        } catch (error) {
...
//# sourceMappingURL=src_4cc6ea90._.js.map