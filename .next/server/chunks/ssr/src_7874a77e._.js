...
async function signInWithGoogle() {
    ...
    // Redirection is now handled by the useAuthRedirect hook.
        ...
        // We don't want to show an error if the user simply closes the popup.
        // We will re-throw other errors to be handled by the UI.
...
function ProfilePage() {
    ...
    const [selectedSkillForUpload, setSelectedSkillForUpload] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleAddSkill = (skillType)=>{
        ...
        const skillToAddName = skillType === 'skillsToTeach' ? newSkillToTeach : newSkillToLearn;
        if (skillToAddName.trim() === '') return;
        const newSkill = {
            name: skillToAddName.trim(),
            verified: false
        };
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDocumentNonBlocking"])(userDocRef, {
            [skillType]: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayUnion"])(newSkill)
        });
    ...
    const handleFileChange = (event)=>{
        ...
        if (file && selectedSkillForUpload) {
            console.log(`Uploading file for ${selectedSkillForUpload}:`, file.name);
        // Here we will eventually trigger the AI verification flow
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    }, void 0, true) : userProfile?.skillsToTeach?.map((skill)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex items-center gap-2 bg-secondary text-secondary-foreground rounded-full text-base py-1 pl-3 pr-2",
                                                            children: [
                                                                skill.name,
...
//# sourceMappingURL=src_7874a77e._.js.map