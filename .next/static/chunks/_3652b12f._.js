...
async function signUpWithEmailAndPassword(email, password, displayName, photoURL) {
    try {
        ...
        // This can fail if the user is created but the profile update doesn't complete.
        // It's better to update the profile information when creating the Firestore doc.
...
async function signOut() {
    ...
    // Let the auth state listener and redirection logic in components handle the navigation
    } catch (error) {
...
function LoginPage() {
    ...
    const handleSignIn = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithGoogle"])();
        // Redirection is handled by the useEffect hook when user state changes.
        } catch (error) {
...
_s(LoginPage, "hpfpOJZlUJnIyeRicnQxMl3pjog=", false, function() {
    return [
...
//# sourceMappingURL=_3652b12f._.js.map