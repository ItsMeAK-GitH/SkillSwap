...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpWithEmailAndPassword"])(email, password);
        if (user) {
            router.push("/");
        }
    };
...
_s(SignupPage, "gXBSDMjBU2K0Yrqb/Ob2M6gJuTo=", false, function() {
    return [
...
//# sourceMappingURL=src_ca5e22ba._.js.map