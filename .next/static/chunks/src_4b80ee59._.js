...
"[project]/src/ai/flows/data:419d13 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$419d13__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:419d13 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/avatar.tsx [app-client] (ecmascript)");
            ...
            const findMatches = {
                "SwapPage.useEffect.findMatches": async ()=>{
                    ...
                    try {
                        ...
                        const allUsersData = {};
                        const allUserProfilesForAI = querySnapshot.docs.map({
                            "SwapPage.useEffect.findMatches.allUserProfilesForAI": (docSnap)=>{
                                ...
                                allUsersData[docSnap.id] = profile;
                                return {
                                    userId: docSnap.id,
                                    skillsToTeach: profile.skillsToTeach.map({
                                        "SwapPage.useEffect.findMatches.allUserProfilesForAI": (s)=>s.name
                                    }["SwapPage.useEffect.findMatches.allUserProfilesForAI"]),
                        ...
                        const matchingInput = {
                            ...
                            allUserProfiles: allUserProfilesForAI
                        };
                        const aiMatches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$419d13__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["skillMatching"])(matchingInput);
                        // 3. Enrich AI matches with user data from the initial fetch
...
//# sourceMappingURL=src_4b80ee59._.js.map